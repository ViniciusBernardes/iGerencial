...
class _HomeDrawerState extends State<HomeDrawer> {
  ...
  void setdDrawerListArray() {
    drawerList = <DrawerList>[
      ...
      DrawerList(
        index: DrawerIndex.ChamadosMG,
        labelName: 'Chamados MG',
        icon: Icon(Icons.dvr),
      ),
      DrawerList(
        index: DrawerIndex.ChamadosES,
        labelName: 'Chamados ES',
        icon: Icon(Icons.content_paste),
      ),
      DrawerList(
        index: DrawerIndex.ListaBoletos,
        labelName: 'Boletos a Vencer',
